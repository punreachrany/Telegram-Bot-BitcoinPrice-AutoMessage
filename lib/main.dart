...
class CrytoTeleBot extends StatefulWidget {
  @override
  _CrytoTeleBotState createState() => _CrytoTeleBotState();
}

class _CrytoTeleBotState extends State<CrytoTeleBot> {
  bool isStart;
  List result = [];
  @override
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          RaisedButton(
            onPressed: () async {
              ...
              // === Please use your Telegram BOT Token ==== //
              var teledart =
                  TeleDart(Telegram('TOKEN from telegram Bot'), Event());

              var url =
                  'API-Key from https://min-api.cryptocompare.com/documentation';
              ...
              while (isStart) {
                ...
                // === Please use your Telegram Chat ID ==== //
                teledart.telegram.sendMessage(' === Telegram Chat ID ===',
